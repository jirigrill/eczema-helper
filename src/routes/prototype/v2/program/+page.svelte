<script lang="ts">
  ...
  import type { PrototypeState, SchedulePhase } from '../_lib/types';
  import { getPhaseForDate, getEliminatedSlugsForDate, detectConflicts, getScheduleProgress, appendReTestPhases, generateDemoData, getReintroductionDayInfo } from '../_lib/schedule-engine';
  import { getCategoryBySlug, formatDateCs, formatDateLongCs, todayIso, addDays, PROTOCOL_SLUGS } from '../_lib/data';
  ...
  import type { ReintroductionEvaluation } from '../_lib/types';
            ...
            {#if expandedPhaseId === phase.id}
              ...
              <div class="ml-11 pb-2 space-y-3 text-xs">
                ...
                <div>
                  ...
                  {:else}
                    <a
                      href="/prototype/v2/day?date={phase.endDate}"
