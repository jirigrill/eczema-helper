...
export const FOODS = [
  ...
  { id: 'pomeranc',          familyId: 'fruit' as FamilyId,       allergenIds: ['citrus'],       form: 'raw-only', sourceGroup: 'exoticke' },
  { id: 'horka-cokolada',   familyId: 'sweet' as FamilyId,       allergenIds: ['chocolate'],    form: 'raw-only', aliases: ['hořká čokoláda', 'dark chocolate'] },
  { id: 'losos',             familyId: 'fish-seafood' as FamilyId,allergenIds: ['fish'],         form: 'cookable', sourceGroup: 'ryby' },
  ...
  { id: 'kvetak',            familyId: 'vegetables' as FamilyId,  allergenIds: ['cabbage-brassica'], form: 'cookable', aliases: ['květák'] },
  { id: 'zeli',               familyId: 'vegetables' as FamilyId,  allergenIds: ['cabbage-brassica'], form: 'cookable', aliases: ['zelí'] },
  { id: 'dyne',               familyId: 'vegetables' as FamilyId,  allergenIds: [],               form: 'cookable', aliases: ['dýně'] },
  { id: 'repa',               familyId: 'vegetables' as FamilyId,  allergenIds: [],               form: 'cookable', aliases: ['řepa'] },
  { id: 'bataty',             familyId: 'vegetables' as FamilyId,  allergenIds: [],               form: 'cookable', aliases: ['batáty'] },
  { id: 'lilek',              familyId: 'vegetables' as FamilyId,  allergenIds: [],               form: 'cookable' },
  { id: 'houby',              familyId: 'vegetables' as FamilyId,  allergenIds: ['mushroom'],     form: 'cookable' },
  // Fruit
  { id: 'jablko',            familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'tuzemske' },
  { id: 'hruska',            familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'tuzemske' },
  { id: 'merunka',           familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'tuzemske' },
  { id: 'broskev',           familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'tuzemske' },
  { id: 'hrozny',            familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'tuzemske' },
  { id: 'svestka',           familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'tuzemske', aliases: ['švestka'] },
  { id: 'tresne',            familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'tuzemske', aliases: ['třešně', 'višně'] },
  ...
  { id: 'banan',             familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'exoticke' },
  { id: 'kiwi',              familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'exoticke' },
  { id: 'mango',             familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'exoticke' },
  { id: 'ananas',            familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'exoticke' },
  { id: 'avokado',           familyId: 'fruit' as FamilyId,       allergenIds: [],               form: 'raw-only', sourceGroup: 'exoticke', aliases: ['avokádo'] },
  { id: 'citron',            familyId: 'fruit' as FamilyId,       allergenIds: ['citrus'],       form: 'raw-only', sourceGroup: 'exoticke' },
  // Meat
  ...
  { id: 'pstruh',            familyId: 'fish-seafood' as FamilyId,allergenIds: ['fish'],         form: 'cookable', sourceGroup: 'ryby' },
  { id: 'tunak',             familyId: 'fish-seafood' as FamilyId,allergenIds: ['fish'],         form: 'cookable', sourceGroup: 'ryby' },
  { id: 'sardinky',          familyId: 'fish-seafood' as FamilyId,allergenIds: ['fish'],         form: 'cookable', sourceGroup: 'ryby' },
  { id: 'makrela',           familyId: 'fish-seafood' as FamilyId,allergenIds: ['fish'],         form: 'cookable', sourceGroup: 'ryby' },
  { id: 'sled',              familyId: 'fish-seafood' as FamilyId,allergenIds: ['fish'],         form: 'cookable', sourceGroup: 'ryby', aliases: ['sleď'] },
