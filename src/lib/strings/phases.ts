...
export const phaseStrings = {
  reset: {
    ...
    badgeLabel: 'Reset',
    description:
      'Jezte normálně (kromě potvrzených alergií). Zaznamenáváme výchozí stav kůže miminka před zahájením eliminace.',
  },
  elimination: {
  ...
  rest: {
    ...
    description:
      'Kůže se zotavuje — jezte pouze potraviny, které miminko toleruje. Žádné nové alergeny nezařazujte.',
  },
  'tolerance-building': {
    label: 'Budování tolerance',
    badgeLabel: 'Budování tolerance',
    description:
      'Malé dávky alergenu max 2× týdně pro budování tolerance. Pokračujte, dokud miminko alergen toleruje.',
  },
