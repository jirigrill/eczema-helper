<!-- The day's user inputs, clearly rendered: what the mother logged (dose / skin
     / reaction) on the selected date — the raw evidence the engine reasoned over
     — plus the derived snapshot the gates read. -->
<script lang="ts">
  import { OUTCOME_LABEL, type DayView } from './adapter';
