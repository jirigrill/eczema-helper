...
| `skills/` | Agent skills vendored from `~/.agents/skills`, copied into the image at `~/.claude/skills` (worker prompt references `tdd`). Re-sync when the source skill changes. |
