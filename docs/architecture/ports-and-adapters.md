...
| `earliestLoggedStore`        | `stores/earliest-logged.ts`             | `readable<string \| null>` — earliest logged day across all meals + skin observations (§3a); app-wide singleton |
